...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("carpadwebapp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("carpadwebapp");
        ...
        config.getMapConfigs().put("com.rasapardaz.carpad.webapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
